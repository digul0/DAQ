...
#include "m_view.h"
Обеспечивает валидацию ответа и разбиению(trim/tagging) цельного ответа на составляющие согласно заданному шаблону
...
Обеспечивает настройку, подключение и интерфейс синхронного чтения/записи в Com-порт.
